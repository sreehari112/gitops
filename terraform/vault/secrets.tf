  ...
  data_json = jsonencode(
    {
      ...
      ATLANTIS_GH_USER                    = "ravichandrapatel",
      ATLANTIS_GH_WEBHOOK_SECRET          = var.atlantis_repo_webhook_secret,
      GITHUB_OWNER                        = "thecaptainhub",
      ...
      TF_VAR_aws_account_id               = "637423629731",
      TF_VAR_aws_region                   = "ap-south-1",
      TF_VAR_hosted_zone_name             = "aws.thecaptainhub.com",
